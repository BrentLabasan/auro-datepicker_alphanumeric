...
const modernConfig = {
  input: {
    ['auro-datepicker-alphanumeric__bundled']: './src/auro-datepicker-alphanumeric.js',
  },
  output: {
    format: 'esm',
    dir: 'dist/'
...
const auroDatepicker_alphanumericConfig = {
  input: 'src/es5.js',
  output: {
    format: 'iife',
    file: 'dist/auro-datepicker-alphanumeric__bundled.es5.js'
  },
  plugins: getSharedPlugins(true)
};

export default [modernConfig, auroDatepicker_alphanumericConfig];
